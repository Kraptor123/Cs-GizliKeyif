...
class BadTv : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "${mainUrl}/six"      to "Tüm Videolar",
        "${mainUrl}/istif/anne"   to "Üvey Anne",
        "${mainUrl}/istif/kuzenler"   to "Kuzen",
        "${mainUrl}/istif/esmer"   to "Esmer",
        "${mainUrl}/istif/milf"   to "Milf",
        "${mainUrl}/istif/yenge"   to "Yenge",
        "${mainUrl}/istif/amator"  to "Amatör"
    )
