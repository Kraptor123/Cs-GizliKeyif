...
class SettingsDialog(val activity: AppCompatActivity, val onSave: () -> Unit) {
    ...
    fun show(mainUrl: String? = null) {
        ...
        // Username Field
        root.addView(TextView(activity).apply { text = "User Name"; setTextColor(Color.GRAY); textSize = 12f })
        ...
        // Password Field
        root.addView(TextView(activity).apply { text = "Password"; setTextColor(Color.GRAY); textSize = 12f })
        val passEdit = createEditText("Password", Settings.getPassword(activity)).apply {
            inputType = android.text.InputType.TYPE_CLASS_TEXT or android.text.InputType.TYPE_TEXT_VARIATION_PASSWORD
        }
        root.addView(passEdit, LinearLayout.LayoutParams(-1, -2).apply { bottomMargin = dpToPx(20) })
        ...
        btnLogout.setOnClickListener {
            ...
            Toast.makeText(activity, "All Cookies Cleared And Logged Out", Toast.LENGTH_SHORT).show()
