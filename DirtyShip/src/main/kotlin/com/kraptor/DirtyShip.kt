...
class DirtyShip(val plugin: DirtyShipPlugin) : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "${mainUrl}/category/anal-efg/" to "Anal",
        "${mainUrl}/category/anime/" to "Anime",
        "${mainUrl}/category/asian-fg/" to "Asian",
        "${mainUrl}/category/asmr-jk/" to "ASMR",
        "${mainUrl}/category/big-boobs-jkl/" to "Big Boobs",
        "${mainUrl}/category/big-dick-1/" to "Big Dick",
        "${mainUrl}/category/blowjob-jk/" to "Blowjob",
        "${mainUrl}/category/celebrity-fg/" to "Celebrity",
        "${mainUrl}/category/cosplayer-xy/" to "Cosplayer",
        "${mainUrl}/category/couple-c/" to "Couple",
        "${mainUrl}/category/fansly-i/" to "Fansly",
        "${mainUrl}/category/indian-1/" to "Indian",
        "${mainUrl}/category/instagram-def/" to "Instagram",
        "${mainUrl}/category/involuntary/" to "Involuntary",
    ...
    override suspend fun search(query: String, page: Int): SearchResponseList {
        val document = app.get("${mainUrl}/page/$page/?search_param=all&s=${query}").document

        val aramaCevap = document.select("li.thumi").mapNotNull { it.toSearchResult() }
